			...
			>
				...
				<div className="relative block order-first">
					...
					<div
						...
						style={{
							transform: badgeHovered
								? "scale(1.05) translateY(-3px)"
								: "scale(1) translateY(0)",
						}}
					>
						<span className="text-[2.2rem] font-black text-[#0B1A08] block leading-none">
							1 in 3
						</span>
				...
				<div>
					...
					<p className="text-base leading-[1.75] tracking-[0.01em] text-[rgba(240,235,225,0.55)] mb-4">
						Every day, tons of perfectly edible food goes to landfill — while
						millions go to bed hungry. RestroPlate exists to close that gap with
						technology, compassion, and community.
					</p>
					<p className="text-base leading-[1.75] tracking-[0.01em] text-[rgba(240,235,225,0.55)] mb-4">
						We work with local restaurants, catering companies, and households
						to list surplus food in real time, matching it instantly with
						verified community partners, shelters, and individuals in need — all
