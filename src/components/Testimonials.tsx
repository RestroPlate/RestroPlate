...
const TESTIMONIALS = [
	{
		...
		initials: "AS",
		quote:
			"We used to discard 15 kg every evening. RestroPlate turned that guilt into pride — our kitchen waste is nearly zero now.",
	},
	{
		name: "David Mensah",
		...
		initials: "DM",
		quote:
			"The real-time notifications mean we can plan pickups efficiently. RestroPlate has doubled the volume we distribute each week.",
	},
	{
		name: "Priya Nair",
		...
		initials: "PN",
		quote:
			"Signing up took two minutes. Within a day I was delivering hot meals to families three blocks from my apartment.",
	},
];
				...
				{TESTIMONIALS.map((t, i) => (
					...
					>
						...
						<span
							...
							style={{
								color: hoveredCard === i ? "rgba(125,197,66,0.9)" : "#7DC542",
							}}
						>
							"
						</span>
