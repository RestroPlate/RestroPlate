  ...
  return (
    <div className="flex min-h-screen bg-[#0B1A08]">
          ...
          {sidebarLinks.map((link) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 rounded-xl px-4 py-3 text-left text-sm font-bold transition ${active
      ...
      <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-[#7DC542]/15 bg-[#0B1A08]/95 px-2 py-2 backdrop-blur md:hidden">
        <div
          className={`grid gap-2 ${sidebarLinks.length === 4 ? "grid-cols-5" : "grid-cols-4"
            }`}
        >
          {sidebarLinks.map((link) => {
            const active = isCurrentPath(
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => navigate(link.path)}
                className={`rounded-xl px-2 py-2 text-center text-[11px] font-bold transition ${active
                  ? "bg-[#7DC542]/15 text-[#7DC542]"
